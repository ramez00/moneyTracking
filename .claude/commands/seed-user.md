...
1. Generates a realistic random Egyption user using your
   own knowledge of common Egyption names across regions:
   - Name: a realistic Egyption first + last name
   - Email: derived from the name with a random 2-3 digit
     number suffix (e.g. ramez.mohamed@gmail.com)
